...
file_path = r"C:\Users\User\OneDrive\Ambiente de Trabalho\Programação VSCode\Projeto\ata_medica_papers.json"
...
def criarPub():
    ...
    while janela_ativa:
        ...
        # Criar publicação
            ...
            # Coletar informações do utilizador
            ...
            if len(partes_data) == 3 and all(p.isdigit() for p in partes_data):
                ...
                if 1 <= mes <= 12 and 1 <= dia <= 31:
                    if mes in [4, 6, 9, 11] and dia > 30:
                        ...
                        # Adicionar ao conjunto de publicações
